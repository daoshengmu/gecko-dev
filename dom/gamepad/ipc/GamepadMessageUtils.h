...
template<>
struct ParamTraits<mozilla::dom::GamepadChannelType> :
  public ContiguousEnumSerializer<mozilla::dom::GamepadChannelType,
                                  mozilla::dom::GamepadChannelType(0),
                                  mozilla::dom::GamepadChannelType(
                                  mozilla::dom::GamepadChannelType::NumGamepadChannelType)> {};
} // namespace IPC
