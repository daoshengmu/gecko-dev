                                   ...
                                   uint32_t aNumButtons, uint32_t aNumAxes)
{
  ...
  GamepadAdded a(NS_ConvertUTF8toUTF16(nsDependentCString(aID)), index,
                 aMapping, GamepadChannelType::Standard, aNumButtons, aNumAxes);
...
GamepadPlatformService::RemoveGamepad(uint32_t aIndex)
{
  ...
  MOZ_ASSERT(XRE_IsParentProcess());
  MOZ_ASSERT(!NS_IsMainThread());
  GamepadRemoved a(aIndex, GamepadChannelType::Standard);
                                       ...
                                       bool aPressed, double aValue)
{
  ...
  MOZ_ASSERT(XRE_IsParentProcess());
  MOZ_ASSERT(!NS_IsMainThread());
  GamepadButtonInformation a(aIndex, GamepadChannelType::Standard,
                                         ...
                                         double aValue)
{
  ...
  MOZ_ASSERT(XRE_IsParentProcess());
  MOZ_ASSERT(!NS_IsMainThread());
  GamepadAxisInformation a(aIndex, GamepadChannelType::Standard,
                           aAxis, aValue);
